      ...
      <body>
        <div class="email-container">
          ...
          <div class="callout warning">
            <strong>Important:</strong> Please remember to email signed copies of all forms to yalesummerdebateprogram@gmail.com by July 15, 2026. Do not reply to this email. Your participation in the program will not be confirmed until all forms have been signed and returned.
          </div>
          ...
          <p>Attached to this email, you'll find copies of all accepted forms for your records. Please remember to sign and email these forms to <a href="mailto:yalesummerdebateprogram@gmail.com">yalesummerdebateprogram@gmail.com</a> by July 15, 2026.</p>
